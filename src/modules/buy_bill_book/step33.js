...
const Step33 = (props) =>{
  ...
  console.log(users,"step11")
    ...
    const [partnerSelectedData, setpartnerSelectedData] = useState(users.buyerInfo);
    ...
    const billEditItem = props.billEditStatus ? props.slectedCropsArray[0] : props.slectedCropsArray ;
    ...
    const callbackFunctionPartySelect = (child, childData, trans,cropTableEditStatus,cropEditObject,billEditStatus,slectedCropstableArray,
        selectedPartyType,selectedBilldate) => {
      setpartnerSelectDate(child);
      setpartnerSelectedData(childData);
      setTranspoSelectedData(trans);
      props.step3ParentCallback(cropTableEditStatus,cropEditObject,billEditStatus,slectedCropstableArray,
        selectedPartyType,selectedBilldate)
    };
