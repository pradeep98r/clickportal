...
import { getBuyerLedgers, getLedgerSummary, getLedgerSummaryByDate, postRecordPayment } from '../../actions/billCreationService';
...
//import DateCalender from '../../modules/buy_bill_book/'
...
const BuyerLedger = () => {
    ...
    const getDate = () => {
        ...
        console.log(`ledgersummary/${partyId}?fromDate=${fromDate}&toDate=${toDate}`);
        $("#datePopupmodal").modal("hide");
        setIsOpen(false);
        navigate(`ledgersummary/${partyId}?fromDate=${fromDate}&toDate=${toDate}`);
    }
    return (
